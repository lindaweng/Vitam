...
function PopUpInstruction(){
  ...
  swal({
    title:"Calibration",
    text: "Please click on each of the 9 points on the screen. You must click on each point 5 times till it goes " + "yellow".bold() + ". This will calibrate your eye movements.",
    buttons:{
      // cancel: false,
      confirm: true
    }
